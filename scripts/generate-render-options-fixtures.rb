...
#
# One run writes `test/formats/mathml/render-options-fixtures.json`,
# `test/formats/omml/render-options-fixtures.json` and
# `test/formats/binary-function/render-kinds-fixtures.json` (the last is the
