 ...
 *
 * Emitted by scripts/generate-core-data.rb from the htmlentities gem the oracle decodes with
 * (ARCHITECTURE.md §1).
 * What it was generated from is in `src/core/generated/provenance.ts`.
 *
 * `HTMLEntities::MAPPINGS["xhtml1"]`, verbatim: entity name -> codepoint.
 *
 ...
 * constructor's default flavour is `xhtml1`. Neither the larger
...
/**
 * How many entities the table must hold. The suite checks the map against it,
 * so a truncated regeneration fails instead of silently decoding less.
 */
export const XHTML1_ENTITY_COUNT: number = 253;

/**
 * Entity name (no `&`, no `;`) -> Unicode codepoint. Lookup is
 ...
 * `&PI;` does not.
 */
export const XHTML1_ENTITY_CODEPOINTS: ReadonlyMap<string, number> = new Map([
  ["AElig", 198],
  ["Aacute", 193],
  ["Acirc", 194],
  ["Agrave", 192],
