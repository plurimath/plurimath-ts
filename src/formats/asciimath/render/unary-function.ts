 ...
 * constructs directly without `get_class` (`newTr` in `../transform.ts`).
 ...
 * (`./sqrt.ts`, `./abs.ts`, ... — and `./norm.ts`, whose `super` is this).
 */
 ...
 * Exported for the inheriting kind files (`./mpadded.ts`, `./linebreak.ts`).
 */
