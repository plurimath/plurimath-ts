...
export const CONTEXT_AXES: readonly ContextAxis[] = [
  ...
  },
  {
    name: "table",
    values: ["false", "true"],
    formats: ["asciimath", "latex", "mathml", "unicodemath", "html", "omml"],
...
export const PROBE_FAILURES: readonly ProbeFailure[] = [
  {
    ...
    format: "mathml",
    template: "bare",
    context: "intent=true table=false rspace=none display_style=false",
  ...
  },
  {
    ...
    format: "mathml",
    template: "bare",
    context: "intent=true table=false rspace=thickmathspace display_style=false",
    error: "Plurimath::Math::ParseError",
  },
  {
    id: "UpcaseDd",
    format: "mathml",
    template: "bare",
    context: "intent=true table=true rspace=none display_style=false",
    error: "Plurimath::Math::ParseError",
  },
  {
    id: "UpcaseDd",
    format: "mathml",
    template: "bare",
    context: "intent=true table=true rspace=thickmathspace display_style=false",
    error: "Plurimath::Math::ParseError",
  },
  {
    id: "UpcaseDd",
