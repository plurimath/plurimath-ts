 ...
 * `log.rb`, `root.rb`, `stackrel.rb`, the two intent-bearing classes
 * `inf.rb` and `intent.rb` — and, for the classes the AsciiMath transform
 * never builds, `over.rb`, `menclose.rb` and `mlabeledtr.rb`, each of which
 * also overrides. The carrier default
