...
const CONTENT_DIGESTS: ReadonlyArray<readonly [string, string]> = [
  [
    ...
    "b0127716e91a0d84d0e8ef3a5a2af94374f6356c73819c5f2575639d4aaafe7c",
  ],
  [
    "UNICODEMATH_BINARY_CARRIER_NAMES",
    "27a4f576b524d1ce380ca79032d7d66135bb1ac936f75f64c6a2ae8c6bc80d1b",
  ],
  [
    "UNICODEMATH_CLASS_OF_FAMILY",
    "e8135a43cb60c8d636ffd0cb465fa7d60c6b2e60f170d9f4c1a37d3565e4bfc5",
  ],
  [
    "UNICODEMATH_DIACRITIC_BELOWS",
    "04728959f4b1266d6d6698417b11c406c1a0e49edf6d6dda00b4f6da219d1483",
  ],
  [
    "UNICODEMATH_DIACRITIC_OVERLAYS",
    "7e775f5541913bc672a89d6f3454f8d27af91611d2ebb9115fdf6842286ffdde",
  ],
  ...
  [
    ...
    "f797b536d90a5798af848cc8049af3bfb69b74ddf9c15b604087bdc01a9d6763",
  ],
  [
    "UNICODEMATH_HORIZONTAL_BRACKETS",
    "5a9409d50c9d3ed3dc4400e0d9d6bf6ed16e8047ca3dd8b6a134f98eea17505b",
  ],
  ["UNICODEMATH_MATRIXS", "70ffe5433db016877e3509522d60e5fda8d221a14d072179259b5dcdfd6b73aa"],
  [
    "UNICODEMATH_NIL_PAREN_MATRIX",
    "76aa34218eb9b491947875491c9a605c775476cba19f38158d62af25c96201df",
  ],
  [
    "UNICODEMATH_PARENTHESIS_MATRICES",
    "d47f1e2150a867ec1efbc518cb1c27a9986f81a4fbe1898834bb9d479c8c0ec6",
  ],
  [
    "UNICODEMATH_PHANTOM_SYMBOLS",
    "0c3920e75b729c79e4e840d7894f65c1f75cc24a93bb53076c9487c239f8a494",
  ],
  [
    "UNICODEMATH_SIZE_OVERRIDES",
    "bb2a74e7fce584199bc6b6de0b33423ea948619c393d066389234e42a497f2b6",
  ],
  ...
  [
    ...
    "00a026f1ec4ce745a8aeed70f5964dd527dbfc60fdaf23d489dcd4c52a4beaa7",
  ],
  ...
  [
    ...
    "289b61cf7da5e89f9b742c52c8379b39d63ecc20c0e463c9b7ffa29c0a18832a",
  ],
  [
    "UNICODEMATH_SYMBOLS_WITHOUT_HEXCODE",
    "2143907738944ea38fba5bc8eec118cc7f4c3f8ef10e65c25bc35097453a8c6a",
  ],
  [
    "UNICODEMATH_UNARY_ARG_FUNCTIONS",
    "f443db0936385c4b268863555bb19645796740aa12732892c3851e85fd313ebc",
  ],
  [
    "UNICODEMATH_UNARY_CARRIER_NAMES",
    "4d31bdff16dd792602b6946c26e26020b44b2d729a544c93eadcee5df5f9b67c",
  ],
  ...
  [
    ...
    "5244dcf5f08ff97bacbedbc40dd99ade31842241bc014ea26d7838add2418fcf",
  ],
  [
    "UNICODEMATH_UNICODE_FRACTIONS",
    "d585a3b6f4fa03b2ac3acf54415fde4bd1badba4d22d7959068b1236135bf22c",
  ],
];
...
describe("the emitted tables still carry the bytes they carried", () => {
  ...
  it("actually notices the mutations the size pins miss", () => {
    ...
    // Not a formality: an empty table would make every mutation below a no-op
    // and this whole proof vacuous.
    expect(first).toBeDefined();
    const [firstKey, firstValue] = first as [string, string];
